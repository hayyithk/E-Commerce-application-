...
//        First, we validate the product and Second, we validate the product Quantity
        ProductResponse productResponse = productServiceClient.getProductDetails(request.getProductId() );
        if(productResponse == null || productResponse.getStockQuantity() < request.getQuantity())
            return false;


//        Third, we validate the user
...
//        Fourth, we find if Item is existed or not
...
//            update the quantity
            ...
            existingCardItem.setPrice(BigDecimal.valueOf(1000.00));
